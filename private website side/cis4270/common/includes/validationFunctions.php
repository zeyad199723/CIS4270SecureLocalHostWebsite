 ...
 * is returned.
 * @param string $param The expected POST request parameter
 * @return NULL|string the POST request parameter value or null
 */
 ...
 * If it is not present, or if the trimmed result is an empty string, null
 * is returned.
 * @param string $param The expected GET request parameter
 * @return NULL|string the GET request parameter value or null
 */
function hGET($param) {
 ...
 * @param string $formatStr the format string that describes how the date string
 * should be formatted
 * @return DateTime object if input is valid, otherwise FALSE
 */
 ...
 * @param string $value the variable being tested
 * @return boolean true if variable contains a value, false otherwise
 */
