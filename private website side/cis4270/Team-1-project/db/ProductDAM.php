	...
	public function writeProduct($product) {
		if ($product->id === null) {
			...
			$query = 'INSERT INTO products
				(categoryID, userID, productName, description, listPrice, discountPercent, imageFilename)
				VALUES
				(:categoryId, :userId, :name, :description, :listPrice, :discountPercent, :imageFilename)';
			$statement = $this->db->prepare($query);
			$statement->bindValue(':categoryId', $product->categoryId, PDO::PARAM_INT);
			$statement->bindValue(':userId', $product->userId, PDO::PARAM_INT);
			$statement->bindValue(':name', $product->name, PDO::PARAM_STR);
			$statement->bindValue(':description', $product->description, PDO::PARAM_STR);
			$statement->bindValue(':listPrice', $product->listPrice, PDO::PARAM_STR);
			$statement->bindValue(':discountPercent', $product->discountPercent, PDO::PARAM_STR);
			$statement->bindValue(':imageFilename', $product->imageFilename, PDO::PARAM_STR);
			$statement->execute();
			$statement->closeCursor();
		} else {
